<form class="flex items-center" autocomplete="off">   
    <div class="relative w-full">
        ...
        <input wire:model="search" type="text" id="simple-search" class="bg-gray-100 border border-white text-gray-900 text-sm rounded-lg focus:ring-blue-300 focus:border-blue-100 block w-full pl-10 p-2.5" placeholder="Ej. Java, Nodejs, React..." required>
    </div>
        @if ($search)
