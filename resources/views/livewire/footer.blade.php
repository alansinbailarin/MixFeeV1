...
<footer class="max-w-6xl mb-8 mx-auto mt-20 px-2 sm:px-6 lg:px-8">
    <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
            <a href="/" class="flex items-center">
                <img src="img/mixfeelogo.png" class="mr-3 h-8">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="https://www.github.com/alansinbailarin" target="_blank" class="hover:underline ">Github</a>
                    </li>
                    <li>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="/" class="hover:underline">Mixfee™</a> Todos los derechos reservados.
        </span>
